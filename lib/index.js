...
exports.httpConnector = exports.EmitResult = exports.registryEntry = exports.hasProperty = void 0;
/*
 ...
 */
var hasProperty = function (object, property) { return object && object.hasOwnProperty(property); };
 ...
 */
var registryEntry = function (fish, props) { return ({
    fish: fish,
    props: props,
}); };
...
exports.EmitResult = {
     ...
     */
    reply: function (code, payload) { return ({
        code: code,
        payload: payload,
    }); },
};
 ...
 */
var httpConnector = function (config) {
    console.info('creating http-connector');
    var pond = config.pond, preSetup = config.preSetup, postSetup = config.postSetup, allowEmit = config.allowEmit, registry = config.registry, eventEmitters = config.eventEmitters;
    var registryRoutes = function (path) {
        return Object.entries(registry || {})
            .map(function (_a) {
            var key = _a[0], value = _a[1];
            var fishId = typeof value.fish === 'function' ? value.fish('{param}').fishId : value.fish.fishId;
            var route = typeof value.fish === 'function' ? "/" + path + "/" + key + "/{param}" : "/" + path + "/" + key;
    ...
    var emitRoutes = Object.keys(eventEmitters || {}).map(function (name) { return "/emit/" + name; });
    ...
    var index = function () { return ({
        ...
        states: __assign({}, registryRoutes('state')),
        emitter: { info: 'POST call. Send event payload as JSON', routes: emitRoutes },
        webSocket: __assign({}, registryRoutes('observe-state')),
    }); };
    ...
    app.use(body_parser_1.urlencoded({ extended: false, limit: bodyLimit }));
    app.use(body_parser_1.json({ limit: bodyLimit }));
    ...
    if (allowEmit) {
        app.post('/emit', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
            var data, tags, payload, axTag, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data = req.body;
                        ...
                        tags = data.tags, payload = data.payload;
        ...
        app.post('/emit/:eventType', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        console.error("catch: internal error. '" + JSON.stringify(req.body, undefined, 2) + "': '" + error_1 + "'", req.body);
